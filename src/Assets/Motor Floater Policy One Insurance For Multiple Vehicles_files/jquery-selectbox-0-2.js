    ...
    $.extend(Selectbox.prototype, {
        ...
        _attachSelectbox: function(target, settings) {
            ...
            sbHolder.data("uid", inst.uid).bind("keydown.sb", function(e) {
                ...
                var alfa = Array('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z');
                var pos = -1;
                if (key >= 65 && key <= 90) {
                    pos = key - 65;
                }
                ...
                if (pos != -1) {
                    var diff=(new Date()-lastkeydowntime);
                    var keychar=alfa[pos];
                    if(diff>1000){
                    ...
                    $this.find("ul").find("a").each(function () {
                        if ($(this).text().toLowerCase().indexOf(searchKey) == 0) {
                            $next = $(this);
                            return false;
                        }
                    });
